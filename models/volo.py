...
#Paper Reference:https://ieeexplore.ieee.org/document/9888055
#CODE Taken From:https://github.com/sail-sg/volo/blob/main/models/volo.py
"""
...
def _cfg(url='', **kwargs):
    return {
        ...
        'mean': IMAGENET_DEFAULT_MEAN, 'std': IMAGENET_DEFAULT_STD, # mean and std kept the same as imagenet
...
class VOLO(nn.Module):
    ...
    """
    def __init__(self, layers, img_size=32, in_chans=3, num_classes=10, patch_size=8,
